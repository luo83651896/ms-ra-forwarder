...
module.exports = async (request: Request, response: Response) => {
  ...
  try {
    ...
    let ssml = ssml =`<speak xmlns="http://www.w3.org/2001/10/synthesis" xmlns:mstts="http://www.w3.org/2001/mstts" xmlns:emo="http://www.w3.org/2009/10/emotionml" version="1.0" xml:lang="en-US"><voice name=${_body.name||"zh-CN-YunxiNeural"}><prosody>${_body.text}</prosody></voice ></speak >`;
    if (ssml == null) {
      throw `转换参数无效`
    }
